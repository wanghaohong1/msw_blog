...
const author = "迷死王";
const domain = "https://wanghaohong1.github.io";
...
export default defineConfig({
  ...
  plugins: [
    ...
    [
      ...
      {
        ga: "GTM-XXXXXXX", // 请替换为自己的谷歌分析 ID，比如 UA-00000000-0
      },
    ],
  ...
  themeConfig: {
    ...
    // GitHub 仓库位置
    repo: "wanghaohong1/wanghaohong1.github.io",
    docsBranch: "main",
